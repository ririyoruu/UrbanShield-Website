...
const TermsAndConditions = () => {
    return (
        <div style={{ fontFamily: 'Inter, Arial, sans-serif', color: '#595959', fontSize: '14px', lineHeight: '1.6' }}>
            <h1 style={{ fontSize: '18px', color: '#000000', fontWeight: 'bold', marginBottom: '8px' }}>
            ...
            <h2 style={{ fontSize: '15px', color: '#09090b', fontWeight: 'bold', marginTop: '24px', marginBottom: '12px' }}>
            ...
            <p style={{ fontSize: '12px', color: '#71717a', textAlign: 'center' }}>
                For inquiries, compliance concerns, or to report a suspected breach, please rapidly escalate the matter to the System Operations Directorate via <strong>urbanshield.ad@gmail.com</strong>.
            </p>
        </div>
    );
};
